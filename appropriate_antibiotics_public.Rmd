...
#write.csv(exclusions,"/Volumes/dmcommon/_DM.Private/CI Program Faculty/+Fellow Franchise/Yarahuan/Protected/Exclusions_1_26.csv", row.names = #FALSE)
...
testingphrases<-"(?i)(?<!no|not|not in|no signs of|no sign of|not concerned for|no concern for|reassured against|reassuring against|no evidence of|not suggestive of|risk factors for|at risk for|high risk for|no concern for|not consistent with)\\s+((?:compensated |decompensated )?shock|critically ill|sepsis|critical illness|septic)(?!\\s(screening|screen))"
...
#save CSN list as CSV
#write.csv(notedatacontext,"/Volumes/dmcommon/_DM.Private/CI Program Faculty/+Fellow Franchise/Yarahuan/Protected/NoteDataContext_1_12.csv",row.names = FALSE)
...
notedata
write.csv(notedata,"/Volumes/dmcommon/_DM.Private/CI Program Faculty/+Fellow Franchise/Yarahuan/Protected/NoteDataForTesting1_12.csv", row.names = FALSE)

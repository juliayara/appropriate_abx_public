...
allNLP_phrases<-c(paste(treatmentfailurephrases,collapse = "|"),paste(aspirationphrases,collapse = "|"),paste(unimmunizedphrases,collapse = "|"))
all_CSN_NLP_list<-c(treatmentfailurecsnlist,aspirationcsnlist,unimmunizedcsnlist)
#make new columns
notedata<-notedata%>%
...
#######Next step to create some summary statistics & presentation for the context & phrases

...
cephalosporinallergy=c("cefdinir","cefotaxime","ceftriaxone","cephalexin","cephalosporins") #list of meds that count as cephalosporin allergy
...
abxculturedata <- abxculturedata %>%
  mutate(reasonforexclusions= if_else(
    CSN %in% excludeinfectionlist2$CSN & reasonforexclusions=="included","excluded other common infection",if_else(reasonforexclusions=="excluded other common infection","excluded other common infection",
    if_else(reasonforexclusions=="below min age","below min age",if_else(reasonforexclusions=="excluded service","excluded service","included")))))
...
aggregate(CSN ~ label, abxchoice, function(x) length(unique(x))) 
```
